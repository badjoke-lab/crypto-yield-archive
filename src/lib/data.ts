...
export const allPlatforms = [...platforms, ...platformsBatch04, ...platformsBatch05, ...platformsBatch06, ...platformsBatch07, ...platformsBatch08, ...platformsBatch09, ...platformsBatch10, ...platformsBatch11, ...platformsBatch12, ...platformsBatch14] as Platform[];
export const allEvents = [...eventsBase, ...eventsBatch03, ...eventsBatch04, ...eventsBatch05, ...eventsBatch06, ...eventsBatch07, ...eventsBatch08, ...eventsBatch09, ...eventsBatch10, ...eventsBatch11, ...eventsBatch12, ...eventsBatch13, ...eventsBatch14] as EventRecord[];
export const allEvidence = [...evidenceBase, ...evidenceBatch03, ...evidenceBatch04, ...evidenceBatch05, ...evidenceBatch06, ...evidenceBatch07, ...evidenceBatch08, ...evidenceBatch09, ...evidenceBatch10, ...evidenceBatch11, ...evidenceBatch12, ...evidenceBatch13, ...evidenceBatch14] as EvidenceRecord[];
export const allOutcomes = [...outcomes, ...outcomesBatch04, ...outcomesBatch05, ...outcomesBatch06, ...outcomesBatch07, ...outcomesBatch08, ...outcomesBatch09, ...outcomesBatch10, ...outcomesBatch11, ...outcomesBatch12, ...outcomesBatch14] as Outcome[];
export const allProducts = [...products, ...productsBatch04, ...productsBatch05, ...productsBatch06, ...productsBatch07, ...productsBatch08, ...productsBatch09, ...productsBatch10, ...productsBatch11, ...productsBatch12, ...productsBatch14] as Product[];
export const allTermsRisk = [...termsRisk, ...termsRiskBatch04, ...termsRiskBatch05, ...termsRiskBatch06, ...termsRiskBatch07, ...termsRiskBatch08, ...termsRiskBatch09, ...termsRiskBatch10, ...termsRiskBatch11, ...termsRiskBatch12, ...termsRiskBatch14] as TermsRisk[];
